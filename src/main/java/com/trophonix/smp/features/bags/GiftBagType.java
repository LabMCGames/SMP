...
public enum GiftBagType {
    ...
    GiftBagType(String prettyName) {
        ...
        this.itemStack = new ItemBuilder(Material.BUNDLE).displayName(prettyName + " &7(Right Click)").lore("&fRight Click this item", "&fto view possible rewards", "&fand open your gift bag!").build();
    }
